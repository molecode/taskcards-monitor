# Use official uv Python Alpine image for smaller size
FROM ghcr.io/astral-sh/uv:python3.12-alpine@sha256:ba8fc3d26628bc566eda4ed792608c42da7093e5b8f941d6260098919a74346c
